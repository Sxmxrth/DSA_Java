...
public class library_management
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        FileReader file = new FileReader("/home/samarth/Desktop/DSA_Java/libraryManagement/x.txt");
        BufferedReader reader = new BufferedReader(file);

        FileReader file2= new FileReader("/home/samarth/Desktop/DSA_Java/libraryManagement/y.txt");
        BufferedReader reader2 = new BufferedReader(file2);

        FileReader file3= new FileReader("/home/samarth/Desktop/DSA_Java/libraryManagement/z.txt");
        BufferedReader reader3 = new BufferedReader(file3);


        Date Rday1 = null,Rday2,Cday;
        boolean e1=false;
